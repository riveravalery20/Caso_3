...
```{r top 5 menos pc1,fig.width=9, fig.height=7}
...
```{r top 5 menos pc2,fig.width=9, fig.height=7}
...
```{r top 5 menos pc3,fig.width=9, fig.height=7}
...
data.frame(
  ...
  `Lo que Mide` = c(
    "Cuán bueno es el sistema de salud del país", 
    "¿Dónde muere la gente? (bebés vs adultos)", 
    "¿Números totales o tasas/porcentajes?"
  ),
  ...
  kbl(
    caption = "Análisis de Dimensiones en Indicadores de Salud Pública",
    align = "l",
    col.names = c("Dimensión", "Nombre Simplificado", "Lo que Mide", "Varianza", "Variable Más Importante"),
    linesep = "\\addlinespace"  # Añade espacio entre filas
  ) %>%
  kable_paper(
    full_width = FALSE, 
    font_size = 11,
