...
y_max <- max(g_sil$data$y) * 1.15

# SOLUCIÓN: Usar scale_x_discrete en lugar de scale_x_continuous
g_sil_final <- g_sil +
  ...
  annotate("text",
           ...
           size = 5,
           hjust = 0.5) +
  # CORRECCIÓN: Usar scale_x_discrete para eje X discreto
