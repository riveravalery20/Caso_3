...
```{r scree-plot:Gráfico de Sedimentación,fig.width=9, fig.height=7}
p2 <- fviz_eig(res.pca, 
         addlabels = TRUE,
         barfill = "#2E8B57",
         barcolor = "#2E8B57",
...
```{r tabla-contribuciones,fig.width=9, fig.height=7}
library(reactable)
...
```{r clusters_elipses_13,fig.width=9, fig.height=7}
library(plotly)
...
```{r distribucion_cluster, echo=FALSE,fig.width=9, fig.height=7}
library(knitr)
library(kableExtra)
