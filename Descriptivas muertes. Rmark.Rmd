...
Este mapa se ve representado con frecuencias en donde los tonos más oscuros equivalen a más frecuencia y los más claros a frecuencias más debiles, las variables que se encuentran representadas en el mapa  están diferenciadas por sexo, cuya tematica se encuentra en causas de muerte, tasas en diferentes edades e indicadores de expectativa de vida. Del mismo modo tambien se encuentran las frecuencias, en las variables que no tienen esa caracterización 
...
```
Los paises mas resaltables dentro de todas las variables son: Rusia, Japon, Republica centro africana (Central African Republic) Mongolia y Uruguay.
Estos paises son los más llamativos segun la categoria en la que se encuentre, su resltez se le atribuye en la proporción de paises con frecuencias que distan demasiado y su ubicación contienental.
Ejemplo de ello es Urugay que es el pais americano con más frecuencia en tasa de suicidios, Rusia como el pais con mayor tasa de envenenamiento accidental en función de otros paises europeos, la republica centro africana como el país con menor expectativa de vida en Africa, Mongolia como el país con mayor procentaje de muertes atribuidas a la polución del aire en Asia y Japon como el país con más expectativa de vida en todo el continente Asiatico
